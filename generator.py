...
def generate_brief():
    ...
    data = {
        ...
        "psych_title": "投资中的'损失厌恶'",
        "psych_content": "心理学家卡尼曼发现：人们亏损1万元的痛苦，需要盈利2万元才能抵消。这就是损失厌恶——我们对亏损的恐惧远大于对盈利的渴望。在股市里，这表现为：涨了拿不住（怕回调），跌了死扛着（不甘心）。结果是赚小钱、亏大钱。怎么破？设定明确的止损线，像机器人一样执行。记住：承认错误并及时止损，是成熟投资者的第一课。",
        "psych_tip": "💡 今日心法：别让昨天的亏损，绑架今天的决策。每一笔交易都是独立的。","today_focus": [
            "A股春节后首个交易日，关注'开门红'",
            "1月LPR数据公布，关注利率动向",
            "特朗普关税细节公布，关注市场反应"
        ],

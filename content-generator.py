...
def generate_domestic():
    ...
    news = [
        ...
        "证监会主席吴清：深化创业板改革，增设更包容上市标准支持新质生产力",
        "发改委：六大新兴支柱产业2030年产值有望超十万亿",
        "娄勤俭盛赞国产人形机器人：非常震撼、非常激动、非常自豪",
        "南京成立江苏首个区级人工智能局，地方政府纷纷布局AI产业",
        "2024年GDP增长5.0%，全年国内生产总值1349084亿元",
    ...
    html += """
    <br>
    <p><em>💭 深度思考：政策底已现，市场底需要时间确认。两会释放的政策信号明确支持新质生产力和AI产业发展，短期震荡不改中期向好趋势。控制好仓位，精选个股。</em></p>
    """
